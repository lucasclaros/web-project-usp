...
const Description = () => {
  ...
  useEffect(() => {
    ...
    if (storedData) {
      ...
      const brownieFromStorage = storedBrownies.find(
        (brownie) => brownie.id.toString() === id
      );
      if (brownieFromStorage) {
        setBrownie(brownieFromStorage);
      } else {
        const defaultBrownie = brownieData.find(
          (brownie) => brownie.id.toString() === id
        );
        setBrownie(defaultBrownie);
      }
    } else {
      const defaultBrownie = brownieData.find(
        (brownie) => brownie.id.toString() === id
          ...
          body={
            <div className="product-description-wrapper centered-content">
                    ...
                    <div className="product-description-info">
                      ...
                      <div className="product-comments">
                        <p className="comment-text centered-content">
                          “É literalmente um dos melhores brownies que eu já comi”
                        </p>
                        <p className="comment-text centered-content">
                          “Nossa Senhora”
                        </p>
                        <p className="comment-text centered-content">
                          “Um dos melhores que eu já comi sem brincadeira”
                        </p>
                      </div>
                    </div>
                  }
              ...
              <div className="description-buttons centered-content">
                ...
                />
                <PausaButton buttonText={"Voltar ao Cardápio"} to={"/menu"} />
              </div>
            </div>
          }
        />
